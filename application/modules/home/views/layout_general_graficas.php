...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url().'css/treeview/jquery.treeview.css'; ?>">
</head>
...
<body id="page-top">
    ...
    <script src="<?php echo base_url("js/chartjs/Chart.js"); ?>"></script>
    ...
    <script src="<?php echo base_url("js/buttons.colVis.js"); ?>"></script>
    ...
    <script src="<?php echo base_url().'js/material-kit.js' ?>"></script>
    ...
    <script src="<?php echo base_url('js/treeview/jquery.treeview.js');?>"></script>
    <script>
    ...
    <?php if (isset($js_k) && is_array($js_k)):?>
        <?php foreach($js_k as $js_key):?>
            <?php echo $js_key;?>
        <?php endforeach;?>
    <?php endif; ?>
</body>
