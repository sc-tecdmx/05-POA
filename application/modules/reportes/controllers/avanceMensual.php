...
class avanceMensual extends MX_Controller
{
    ...
    {
		$nombreMes = $this->seguimiento_model->getNombreMes($mes);
        ...
        $sheet->setCellValue("I4", ucfirst($nombreMes->nombre));
        $sheet->setCellValue("L4", 'Avance Acumulado '.ucfirst($nombreMes->nombre));
		...
		$filename = 'avance_mensual_'.ucfirst($nombreMes->nombre); // set filename for excel file to be exported
