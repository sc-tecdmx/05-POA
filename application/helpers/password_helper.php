...
/**
 * Agregado para funcionar el helper de otra biblioteca de drupal includes/bootstrap.inc
 */
/**
...
/**
 * Encode bytes into printable base 64 using the *n
ix standard from crypt().
 *
 * @param $input
 ...
 *   A plain-text password
 * @param $regpass
 *   El password guardado en la base para comparar.
 *
 * @return
 *   TRUE or FALSE.
 */
function user_check_password($password, $regpass) {
	if (substr($regpass, 0, 2) == 'U$') {
		// This may be an updated password from user_update_7000(). Such hashes
		// have 'U' added as the first character and need an extra md5().
		$stored_hash = substr($regpass, 1);
